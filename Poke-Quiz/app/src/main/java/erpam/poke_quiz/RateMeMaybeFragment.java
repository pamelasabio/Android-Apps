...
public class RateMeMaybeFragment extends DialogFragment implements
   ...
   // private String negativeBtn;
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        this.preUtil = new PreUtil(getActivity());
    ...
    public void onClick(DialogInterface dialog, int choice) {
        switch (choice) {
            case DialogInterface.BUTTON_POSITIVE:
                preUtil.saveBonusStatus("1");
                Intent j = new Intent(getActivity().getApplicationContext(),FirstMenu.class);
                startActivity(j);
                mInterface._handlePositiveChoice();
                break;
            case DialogInterface.BUTTON_NEUTRAL:
                preUtil.saveBonusStatus("0");
                Intent i = new Intent(getActivity().getApplicationContext(),FirstMenu.class);
                startActivity(i);
